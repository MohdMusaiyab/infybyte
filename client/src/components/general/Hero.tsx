  ...
  return (
    <div className="relative min-h-screen bg-white overflow-hidden">
      ...
      <div className="absolute inset-0 overflow-hidden">
        ...
        <div className="absolute bottom-20 right-32 text-6xl opacity-5 animate-pulse delay-700">
          🌮
        </div>
      </div>
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6 pt-16 pb-24">
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center mt-12">
          <div>
            <div
              className={`inline-flex items-center gap-2 px-4 py-2 bg-black text-white rounded-full mb-6 transition-all duration-1000 delay-200 ${
                isVisible
                  ? "opacity-100 translate-y-0"
                  : "opacity-0 translate-y-10"
              }`}
            ...
            <p
              className={`text-xl md:text-2xl text-gray-600 mb-8 leading-relaxed transition-all duration-1000 delay-500 ${
                isVisible
                  ? "opacity-100 translate-y-0"
                  : "opacity-0 translate-y-10"
              }`}
            ...
            <div
              className={`space-y-4 mb-10 transition-all duration-1000 delay-700 ${
                isVisible
                  ? "opacity-100 translate-y-0"
                  : "opacity-0 translate-y-10"
              }`}
            >
              ...
              <div className="flex items-center gap-3">
                ...
                <span className="text-lg text-gray-700">
                  Check menus before visiting the food court
                </span>
              </div>
              ...
              <div className="flex items-center gap-3">
                ...
                <span className="text-lg text-gray-700">
                  Browse all vendors in one place
                </span>
              </div>
            </div>
                    ...
                    <div className="space-y-3">
                      <div className="p-4 border-2 border-black rounded-2xl">
                        ...
                        <div className="text-sm text-gray-600">
                          <div
                            className="font-medium text-black mb-1 overflow-hidden"
                            style={{ height: "24px" }}
                          >
