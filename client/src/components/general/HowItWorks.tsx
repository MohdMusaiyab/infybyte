  ...
  const steps = [
    {
      ...
      description:
        "Food court vendors easily mark items as available or sold out through simple dashboard",
      color: "bg-black",
      delay: "delay-200",
    },
    {
      ...
      description:
        "Menu changes instantly reflect on the website and mobile app for all customers",
      color: "bg-black",
      delay: "delay-400",
    },
    {
      ...
      description:
        "See exactly what's available before visiting - no more wasted trips or disappointment",
      color: "bg-black",
      delay: "delay-600",
    },
  ];
  ...
  return (
    <div className="relative bg-white py-24 overflow-hidden" id="howitworks">
      ...
      <div className="absolute inset-0 overflow-hidden">
        ...
        <div className="absolute top-10 right-10 text-6xl opacity-5 animate-pulse">
          📱
        </div>
        <div className="absolute bottom-20 left-20 text-6xl opacity-5 animate-pulse delay-500">
          🍽️
        </div>
        <div className="absolute top-40 left-32 text-6xl opacity-5 animate-pulse delay-1000">
          🔄
        </div>
      </div>
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6">
        <div className="text-center mb-20">
          <div
            className={`inline-flex items-center gap-2 px-4 py-2 bg-black text-white rounded-full mb-6 transition-all duration-1000 ${
              isVisible
          ...
          <h2
            className={`text-4xl md:text-5xl lg:text-6xl font-bold tracking-tight text-black mb-6 transition-all duration-1000 delay-200 ${
              isVisible
                ? "opacity-100 translate-y-0"
                : "opacity-0 translate-y-10"
            }`}
          ...
          <p
            className={`text-xl md:text-2xl text-gray-600 max-w-3xl mx-auto leading-relaxed transition-all duration-1000 delay-300 ${
              isVisible
                ? "opacity-100 translate-y-0"
                : "opacity-0 translate-y-10"
            }`}
          >
            Transform your food court experience in three simple steps. No more
            guesswork, no more wasted trips.
          </p>
        </div>
          ...
          {steps.map((step, index) => (
            ...
            >
              ...
              <div className="bg-white border-2 border-black rounded-3xl p-8 pt-12 group-hover:shadow-2xl group-hover:-translate-y-2 transition-all duration-300 h-full">
                <div
                  className={`w-16 h-16 ${step.color} rounded-2xl flex items-center justify-center mb-6 group-hover:scale-110 transition-transform duration-300 border-2 border-black`}
                >
        ...
        <div
          className={`bg-black rounded-3xl p-8 md:p-12 relative overflow-hidden transition-all duration-1000 delay-700 ${
          ...
          <div className="relative z-10 grid lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-xl text-gray-300 mb-8 leading-relaxed">
                Watch how menu changes sync instantly across all platforms. What
                vendors update is what customers see - in real-time.
              </p>
              ...
              <a
                href="/demo-dashboard"
                className="group px-8 py-4 bg-white text-black text-lg font-semibold rounded-xl hover:bg-gray-100 transition-all duration-300 hover:scale-105 hover:shadow-2xl flex items-center gap-2 border-2 border-black"
              >
                View Demo Dashboard
        ...
        >
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
            <a
              href="/register"
              className="group px-8 py-4 bg-black text-white text-lg font-semibold rounded-xl hover:bg-gray-800 transition-all duration-300 hover:scale-105 hover:shadow-2xl flex items-center gap-2 border-2 border-black"
            >
              Get Started Today
              <ArrowRight className="w-5 h-5 group-hover:translate-x-1 transition-transform" />
            </a>
            ...
            <a
              href="/register"
              className="group px-8 py-4 bg-white text-black text-lg font-semibold rounded-xl border-2 border-black hover:bg-black hover:text-white transition-all duration-300 hover:scale-105 flex items-center gap-2"
            >
