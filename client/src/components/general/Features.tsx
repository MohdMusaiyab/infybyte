    ...
    vendors: [
      {
        ...
        description:
          "Update availability across all food courts in seconds. No more manual whiteboard rewriting.",
        benefits: [
      ...
      },
      {
        ...
        description:
          "Manage menus for multiple food courts from a single dashboard. Perfect for vendors with multiple stalls.",
        benefits: [
          "Centralized control",
          "Consistent branding",
      ...
      },
      {
        ...
        description:
          "Track popular items, peak hours, and customer preferences to optimize your offerings.",
        benefits: [
    ...
    customers: [
      {
        ...
        description:
          "See exactly what's available before you visit. Live status updates every 30 seconds.",
        benefits: [
          "No wasted trips",
      ...
      },
      {
        ...
        title: "Time Saver",
        description:
          "Check all vendors in 30 seconds instead of walking through the entire food court.",
        benefits: [
      ...
      },
      {
        ...
        description:
          "Get personalized suggestions based on your preferences and current availability.",
        benefits: [
    ...
    admins: [
      {
        ...
        description:
          "Complete dashboard to manage vendors, menus, and platform settings for your food court.",
        benefits: [
      ...
      },
      {
        ...
        description:
          "Easily onboard new vendors and manage existing partnerships with simple tools.",
        benefits: [
          "Quick setup",
          "Reduced paperwork",
      ...
      },
      {
        ...
        description:
          "Monitor foot traffic, popular times, and overall food court performance metrics.",
        benefits: [
          "Data-driven decisions",
          "Space optimization",
          "Revenue analysis",
  ...
  return (
    <div className="relative bg-white py-24 overflow-hidden">
      <div className="absolute inset-0 overflow-hidden">
        ...
        <div className="absolute top-20 right-20 text-6xl opacity-5 animate-pulse">
          📊
        </div>
        <div className="absolute bottom-32 left-32 text-6xl opacity-5 animate-pulse delay-500">
          ⚡
        </div>
        <div className="absolute top-1/2 left-20 text-6xl opacity-5 animate-pulse delay-1000">
          🎯
        </div>
      </div>
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6">
        <div className="text-center mb-16">
          ...
          <p className="text-xl md:text-2xl text-gray-600 max-w-3xl mx-auto leading-relaxed">
            Comprehensive tools designed specifically for food courts, vendors,
        ...
        <div className="text-center mt-16">
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
            <a
              href="/register"
              className="group px-8 py-4 bg-black text-white text-lg font-semibold rounded-xl hover:bg-gray-800 transition-all duration-300 hover:scale-105 hover:shadow-2xl flex items-center gap-2"
            >
