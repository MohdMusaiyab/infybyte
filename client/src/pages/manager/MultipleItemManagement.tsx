...
const MultipleItemManagement: React.FC = () => {
  ...
  useEffect(() => {
    if (lastMessage && lastMessage.type === "item_foodcourt_update") {
      ...
      console.log("🔄 Real-time update in MultipleItemManagement:", {
        update,
        action,
      });
