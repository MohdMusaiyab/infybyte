...
const SingleItemDetail: React.FC = () => {
  const { foodCourtId, itemId } = useParams<{
    foodCourtId: string;
    itemId: string;
  }>();
  ...
  useEffect(() => {
    if (lastMessage && lastMessage.type === "item_foodcourt_update") {
      ...
      console.log("🔄 Real-time update received in SingleItemDetail:", {
        update,
        action,
      });
  ...
  }, [lastMessage, itemId, foodCourtId]);
    ...
    const fetchItemData = async () => {
      ...
      try {
        ...
        const response = await axiosInstance.get(
          `/manager/foodcourts/${foodCourtId}/items/${itemId}`
        );
        ...
        setFormData({
          ...
          isActive:
            transformedItem.isActive !== undefined
              ? transformedItem.isActive
              : true,
            ...
            <div className="flex items-start justify-between">
              <div>
                ...
                <p className="text-gray-600 mb-4">
                  {foodCourt?.name} • {foodCourt?.location}
                </p>
                  ...
                  <div className="grid grid-cols-2 lg:grid-cols-4 gap-2">
                    {[
                      ...
                      <button
                        ...
                        type="button"
                        onClick={() =>
                          handleStatusChange(status as FormData["status"])
                        }
                  ...
                  <div className="grid grid-cols-2 lg:grid-cols-4 gap-2">
                    {["breakfast", "lunch", "snacks", "dinner"]?.map((slot) => (
                      <button
                        ...
                        type="button"
                        onClick={() =>
                          handleTimeSlotChange(slot as FormData["timeSlot"])
                        }
                        className={`p-3 rounded-xl border-2 transition-all duration-200 font-medium ${
                ...
                <div className="flex items-center justify-between p-4 border-2 border-gray-200 rounded-xl">
                  <div>
                    ...
                    <p className="text-sm text-gray-500">
                      Show or hide this item in the food court
                    </p>
                  </div>
                  <button
                    type="button"
