  ...
  const fetchItemDetails = async () => {
    try {
      ...
      const transformedData: ItemDetailsResponse = {
        ...
        availability: apiData.availability || null,
      };
      ...
      if (err instanceof AxiosError) {
        const responseData = err.response?.data as
          ...
          | undefined;
        setError(
          responseData?.message ?? err.message ?? "Failed to load item details"
        );
      } else {
              ...
              <div className="text-center">
                ...
                <div className="text-sm text-gray-600 mb-4">
                  {data.availability === null ? (
                    ...
                    <span>Available at {totalLocations} location(s)</span>
                  )}
                </div>
              </div>
            </div>
            ...
            <div>
              ...
              <p className="text-gray-600">
                {data.availability === null
                  ...
                  : "Available at these food courts"}
              </p>
            </div>
          ...
          {data.availability === null ? (
            <div className="text-center py-8">
              ...
              <p className="text-gray-600 mb-4">
                This item is not available at any food court at the moment.
              </p>
              <button
                onClick={fetchItemDetails}
            ...
            <div className="text-center py-8">
              ...
              <p className="text-gray-600">
                This item is not currently available at any food court.
              </p>
            </div>
          ) : (
            <>
              ...
              {filteredAvailability.length === 0 ? (
                <div className="text-center py-8">
                  <MapPin className="w-12 h-12 text-gray-400 mx-auto mb-4" />
                  <h3 className="text-lg font-bold text-black mb-2">
                    No locations found for this time slot
                  </h3>
                  <p className="text-gray-600">
                    Try selecting a different time slot or view all times.
                  </p>
                </div>
              ) : (
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  {filteredAvailability.map((avail) => (
                    <div
                      ...
                      className="bg-gray-50 rounded-xl p-6 border-2 border-gray-200 hover:border-black transition-all duration-300 cursor-pointer group relative"
                    >
                      {!avail.isActive && (
                      ...
                      <div className="space-y-2 mb-4">
                        <div className="flex items-center justify-between text-sm">
                          ...
                          <span className="font-bold text-black text-lg">
                            ₹
                            {avail.price !== undefined
                              ? avail.price
                              : data.item.basePrice}
                          </span>
                        </div>
                        {avail.price !== undefined &&
                          avail.price !== data.item.basePrice && (
                            <div className="flex items-center justify-between text-sm">
                      ...
                      <div className="flex items-center justify-between text-sm">
                        <div className="flex items-center gap-2">
                          <div
                            className={`w-2 h-2 rounded-full ${
                              avail.isOpen ? "bg-green-500" : "bg-red-500"
                            }`}
                          />
                          <span
                            className={
                              avail.isOpen ? "text-green-600" : "text-red-600"
                            }
                          >
          ...
          <div className="bg-white rounded-2xl p-6 border-2 border-gray-200">
            ...
            <div className="space-y-3">
              ...
              <div className="flex items-center justify-between">
                ...
                <span
                  className={`font-medium ${
                    data.item.isVeg ? "text-green-600" : "text-red-600"
                  }`}
                >
                  {data.item.isVeg ? "Vegetarian" : "Non-Vegetarian"}
                </span>
              ...
              <div className="flex items-center justify-between">
                ...
                <span
                  className={`font-medium ${
                    data.item.isSpecial ? "text-yellow-600" : "text-gray-600"
                  }`}
                >
