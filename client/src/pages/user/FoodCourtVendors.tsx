...
import { type FoodItem, type FoodCourt } from "../../types/type";
          ...
          itemsData = (itemsData as Array<unknown>).map((vendor) => {
            ...
            return {
              ...
              items: typedVendor.items.map((itemArray: KeyValue[]) => {
                ...
                return itemObj as unknown as FoodItem;
              }),
            };
          });
        }
      ...
      if (err instanceof AxiosError) {
        ...
        setError(
          responseData?.message ??
            err.message ??
            "Failed to load vendors and items"
        );
      } else {
      ...
      <div className="max-w-4xl mx-auto">
        <div className="mb-6">
          ...
          <div className="flex items-center justify-between">
            ...
            <div
              className={`flex items-center gap-2 px-3 py-1 rounded-full text-sm font-medium ml-4 ${
                isConnected
                  ? "bg-green-100 text-green-800"
              ...
              >
                ...
                >
                  <div className="flex items-center gap-4">
                    ...
                    <div>
                      <Link to={`/user/vendors/${vendor.vendorId}`}>
                          ...
                          >
                            <Link to={`/user/item/${item.itemId}`}>
                              <div className="flex justify-between items-start mb-3">
                                <h4 className="font-bold text-black text-sm line-clamp-2">
                                  {item.name}
                                </h4>
                              </div>
                            </Link>
