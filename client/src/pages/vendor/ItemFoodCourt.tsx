...
const ItemFoodCourt: React.FC = () => {
  ...
  const statusOptions = [
    ...
    { value: "notavailable", label: "Not Available", color: "bg-red-100 text-red-800" },
    { value: "sellingfast", label: "Selling Fast", color: "bg-orange-100 text-orange-800" },
    { value: "finishingsoon", label: "Finishing Soon", color: "bg-yellow-100 text-yellow-800" }
  ];
  ...
  const handlePriceChange = async (foodCourtItemId: string, value: string) => {
    ...
    setFoodCourts(prev => prev.map(fc => 
      fc.id === foodCourtItemId ? { ...fc, price: finalValue ? parseFloat(finalValue) : undefined } : fc
    ));
  };
          ...
          <div>
            ...
            {foodCourts.length === 0 ? (
              ...
              <div className="space-y-4">
                {foodCourts.map((fc) => (
                  <div key={fc.id} className="bg-white rounded-2xl p-6 border-2 border-gray-200 hover:shadow-lg transition-all duration-300">
                    <div className="flex items-start justify-between mb-4">
                      <div className="flex items-start gap-3">
                        ...
                        <div>
                          <h3 className="font-bold text-black">{fc.foodCourtName}</h3>
                      ...
                      <div>
                        ...
                        <div className="relative">
                          ...
                          <input
                            ...
                            onChange={(e) => handlePriceChange(fc.id, e.target.value)}
                            onBlur={(e) => handlePriceBlur(fc.id, e.target.value)}
                    ...
                    <div className="flex justify-end">
                      ...
                      >
                        {updating === fc.id ? <Loader className="w-4 h-4 animate-spin" /> : <XCircle className="w-4 h-4" />}
          ...
          <div>
            ...
            {availableFoodCourts.filter(fc => !foodCourtAssociationMap.has(fc.id)).length === 0 ? (
              <div className="bg-white rounded-2xl p-8 text-center border-2 border-gray-200">
                ...
                <p className="text-gray-500 mb-2">This item is available in all your food courts.</p>
                <p className="text-sm text-gray-400">Great job! You've covered all locations.</p>
              </div>
            ) : (
              <div className="space-y-4">
                {availableFoodCourts
                    ...
                    <div key={fc.id} className="bg-white rounded-2xl p-6 border-2 border-gray-200 hover:shadow-lg transition-all duration-300">
                      ...
                      <div className="flex items-center justify-between">
                        <div className="flex items-center gap-2">
                          <div className={`w-2 h-2 rounded-full ${fc.isOpen ? 'bg-green-500' : 'bg-red-500'}`}></div>
                        ...
                        >
                          {adding === fc.id ? <Loader className="w-4 h-4 animate-spin" /> : <Plus className="w-4 h-4" />}
